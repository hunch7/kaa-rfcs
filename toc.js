...
<html lang="en">
  ...
  <meta property="fb:app_id" content="1401488693436528">
    ...
    <meta content="https://avatars0.githubusercontent.com/u/509837?s=400&amp;v=4" property="og:image" /><meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="ghiculescu/jekyll-table-of-contents" property="og:title" /><meta content="https://github.com/ghiculescu/jekyll-table-of-contents" property="og:url" /><meta content="jekyll-table-of-contents - A simple JavaScript table of contents, designed for Jekyll (or similar) sites." property="og:description" />

  <link rel="assets" href="https://assets-cdn.github.com/">
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjE2MDQ5NDIwOmRlMjA4OTE3OTVjOGZhYjQzOWJiZDM2YTUyMjIzZTBjNTY1MzkyYTcyYmJlNDc1ZTVjYjEyNDdjYjdiMjU1ZmQ=--9e05387e5218642139d2bcf437644aed6df6fa18">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="E7D6:2283:83BDA8D:E3DEE85:5A427231" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="E7D6:2283:83BDA8D:E3DEE85:5A427231" name="octolytics-dimension-request_id" /><meta content="iad" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" /><meta content="15980649" name="octolytics-actor-id" /><meta content="hunch7" name="octolytics-actor-login" /><meta content="ddccaac465d36e9e1903945c850b37374187c81083473f46f2f3de78185fc127" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="hunch7">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="">

    <meta name="enabled-features" content="UNIVERSE_BANNER,FREE_TRIALS">

  <meta name="html-safe-nonce" content="1d1ae968025ddaab3d520183acaf8d3f839e820c">
  ...
  <meta content="509837" name="octolytics-dimension-user_id" /><meta content="ghiculescu" name="octolytics-dimension-user_login" /><meta content="8119591" name="octolytics-dimension-repository_id" /><meta content="ghiculescu/jekyll-table-of-contents" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="8119591" name="octolytics-dimension-repository_network_root_id" /><meta content="ghiculescu/jekyll-table-of-contents" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/ghiculescu/jekyll-table-of-contents/search" class="js-site-search-form" data-scoped-search-url="/ghiculescu/jekyll-table-of-contents/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/ghiculescu/jekyll-table-of-contents/blob/master/toc.js" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown js-menu-container">
    ...
    <a href="/notifications" aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-channel="notification-changed:15980649" data-ga-click="Header, go to notifications, icon:read" data-hotkey="g n">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@hunch7" class="avatar float-left mr-1" src="https://avatars1.githubusercontent.com/u/15980649?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">hunch7</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/hunch7" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/hunch7?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="N6WY3kBnV0LAKx1gKYyEkJKIWIyRDeNhAzJiA2FVNubaVABN3TdgbgfbeB1hSzovcobbXK3+nLvxOpeSkCdBtw==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="zvwlL2yW3AJZkzKScOddh7jGVuGHBT3aNZFIp1xXvOEjDb288cbrLp5jV+84IOM4WMjVMbv2QgDHmb02rSXLsA==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="YhYkqzLbOQm6xHMTU52FiNX2iF44HoqTE2X28zCXjU+rU+WNWdqFLfgAefkqu+X2pgU7rVVfEb/XsEuHTfnEDg==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="8119591" />
        ...
        <div class="select-menu js-menu-container js-select-menu">
          ...
          <a class="social-count js-social-count"
            href="/ghiculescu/jekyll-table-of-contents/watchers"
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/ghiculescu/jekyll-table-of-contents/unstar" class="starred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="d59ZjfBsjwXwN/AKXjfVM9j2jPNL9B+FV68iCtfMKEB804CKML8+DnimWOxUXNwBYJjTqme0ZzyyjDAczjBbdQ==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/ghiculescu/jekyll-table-of-contents/star" class="unstarred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="VHvEm7+vloMEG/1hTqRCAsA8vHnSBb3RgfI5e4rYZ+R1hCmLG/2rshXn3Bx9pEMdiCu4xlDO3ZT4OvXUK5Zxhg==" /></div>
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/ghiculescu/jekyll-table-of-contents/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="nrYbgMSvH5Opj8c6V1ZjnSm6ot1NlMVGwsZktLN5kw1Si6PuwTH1aH1y7DPDWQ84ciKyQUsPa6ztiDJ3u9GkSQ==" /></div>
            <button
                type="submit"
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/ghiculescu/jekyll-table-of-contents" class="js-selected-navigation-item selected reponav-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /ghiculescu/jekyll-table-of-contents" itemprop="url">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    ...
    <a href="/ghiculescu/jekyll-table-of-contents/projects" class="js-selected-navigation-item reponav-item" data-hotkey="g b" data-selected-links="repo_projects new_repo_project repo_project /ghiculescu/jekyll-table-of-contents/projects">
  ...
  <a href="/ghiculescu/jekyll-table-of-contents/pulse" class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse /ghiculescu/jekyll-table-of-contents/pulse">
...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <a href="/ghiculescu/jekyll-table-of-contents/blob/6e442de268cccd0aa67f5466fd1f51ce9a422adf/toc.js" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:ffe3fdc8e834faeb1d0950158e0b8d3b -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/ghiculescu/jekyll-table-of-contents/commit/d589d82e244dcdedf4085182f568a6aed29962ac" data-pjax>
          d589d82
        </a>
        <relative-time datetime="2016-11-21T09:41:29Z">Nov 21, 2016</relative-time>
      </span>
      <div>
        <img alt="@FokkeZB" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/2699409?s=40&amp;v=4" width="20" />
        <a href="/FokkeZB" class="user-mention" rel="contributor">FokkeZB</a>
          <a href="/ghiculescu/jekyll-table-of-contents/commit/d589d82e244dcdedf4085182f568a6aed29962ac" class="message" data-pjax="true" title="Fix eslint error: &#39;i&#39; is not defined">Fix eslint error: 'i' is not defined</a>
      </div>
      ...
      <button type="button" class="btn-link muted-link contributors-toggle" data-facebox="#blob_contributors_box">
        <strong>9</strong>
         contributors
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="heristop" href="/ghiculescu/jekyll-table-of-contents/commits/master/toc.js?author=heristop"><img alt="@heristop" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/206870?s=40&amp;v=4" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="ghiculescu" href="/ghiculescu/jekyll-table-of-contents/commits/master/toc.js?author=ghiculescu"><img alt="@ghiculescu" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/509837?s=40&amp;v=4" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="antoine-richard" href="/ghiculescu/jekyll-table-of-contents/commits/master/toc.js?author=antoine-richard"><img alt="@antoine-richard" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/1552897?s=40&amp;v=4" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="eksperimental" href="/ghiculescu/jekyll-table-of-contents/commits/master/toc.js?author=eksperimental"><img alt="@eksperimental" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/9133420?s=40&amp;v=4" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="nscyclone" href="/ghiculescu/jekyll-table-of-contents/commits/master/toc.js?author=nscyclone"><img alt="@nscyclone" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/5345029?s=40&amp;v=4" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="Neway6655" href="/ghiculescu/jekyll-table-of-contents/commits/master/toc.js?author=Neway6655"><img alt="@Neway6655" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/1468302?s=40&amp;v=4" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="FokkeZB" href="/ghiculescu/jekyll-table-of-contents/commits/master/toc.js?author=FokkeZB"><img alt="@FokkeZB" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/2699409?s=40&amp;v=4" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="drewcrawford" href="/ghiculescu/jekyll-table-of-contents/commits/master/toc.js?author=drewcrawford"><img alt="@drewcrawford" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/183400?s=40&amp;v=4" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="Anthodev" href="/ghiculescu/jekyll-table-of-contents/commits/master/toc.js?author=Anthodev"><img alt="@Anthodev" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/1784889?s=40&amp;v=4" width="20" /> </a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          <li class="facebox-user-list-item">
            <img alt="@heristop" height="24" src="https://avatars3.githubusercontent.com/u/206870?s=48&amp;v=4" width="24" />
            <a href="/heristop">heristop</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@ghiculescu" height="24" src="https://avatars3.githubusercontent.com/u/509837?s=48&amp;v=4" width="24" />
            <a href="/ghiculescu">ghiculescu</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@antoine-richard" height="24" src="https://avatars3.githubusercontent.com/u/1552897?s=48&amp;v=4" width="24" />
            <a href="/antoine-richard">antoine-richard</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@eksperimental" height="24" src="https://avatars0.githubusercontent.com/u/9133420?s=48&amp;v=4" width="24" />
            <a href="/eksperimental">eksperimental</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@nscyclone" height="24" src="https://avatars1.githubusercontent.com/u/5345029?s=48&amp;v=4" width="24" />
            <a href="/nscyclone">nscyclone</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@Neway6655" height="24" src="https://avatars1.githubusercontent.com/u/1468302?s=48&amp;v=4" width="24" />
            <a href="/Neway6655">Neway6655</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@FokkeZB" height="24" src="https://avatars1.githubusercontent.com/u/2699409?s=48&amp;v=4" width="24" />
            <a href="/FokkeZB">FokkeZB</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@drewcrawford" height="24" src="https://avatars1.githubusercontent.com/u/183400?s=48&amp;v=4" width="24" />
            <a href="/drewcrawford">drewcrawford</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@Anthodev" height="24" src="https://avatars3.githubusercontent.com/u/1784889?s=48&amp;v=4" width="24" />
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/ghiculescu/jekyll-table-of-contents/raw/master/toc.js" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/ghiculescu/jekyll-table-of-contents/blame/master/toc.js" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/ghiculescu/jekyll-table-of-contents/commits/master/toc.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>


        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/ghiculescu/jekyll-table-of-contents/edit/master/toc.js" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="MFaeyQVwPiMpba2SVCzfWYE4nNCKkOCvuANPWzMstcpQLBQIY4D5mLDZetPOIRLjVC14u/p+SlA/+YuPagP/GQ==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/ghiculescu/jekyll-table-of-contents/delete/master/toc.js" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="e0pTospqkdZjoGcXm0Y2eefEFyugT0J84+d4b6eFN0DsC2vKbwJL32+EUikL3IEXH5BMz7tZz1H6SyGMAoFCRQ==" /></div>
  ...
  <div itemprop="text" class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC1" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">//</span> https://github.com/ghiculescu/jekyll-table-of-contents</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC9" class="blob-code blob-code-inner js-file-line">      listType<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">&#39;</span>ol<span class="pl-pds">&#39;</span></span>, <span class="pl-c"><span class="pl-c">//</span> values: [ol|ul]</span></td>
      </tr>
      <tr>
        <td id="L10" class="blob-num js-line-number" data-line-number="10"></td>
        <td id="LC10" class="blob-code blob-code-inner js-file-line">      showEffect<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">&#39;</span>show<span class="pl-pds">&#39;</span></span>, <span class="pl-c"><span class="pl-c">//</span> values: [show|slideDown|fadeIn|none]</span></td>
      </tr>
      <tr>
        <td id="L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-code blob-code-inner js-file-line">      showSpeed<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">&#39;</span>slow<span class="pl-pds">&#39;</span></span>, <span class="pl-c"><span class="pl-c">//</span> set to 0 to deactivate effect</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC30" class="blob-code blob-code-inner js-file-line">      <span class="pl-c"><span class="pl-c">//</span> get all headers with an ID</span></td>
      </tr>
      <tr>
        <td id="L31" class="blob-num js-line-number" data-line-number="31"></td>
        <td id="LC31" class="blob-code blob-code-inner js-file-line">      <span class="pl-k">var</span> previousSiblingName <span class="pl-k">=</span> <span class="pl-en">$</span>(<span class="pl-c1">this</span>).<span class="pl-en">prev</span>().<span class="pl-en">attr</span>( <span class="pl-s"><span class="pl-pds">&quot;</span>name<span class="pl-pds">&quot;</span></span> );</td>
      </tr>
      <tr>
        <td id="L32" class="blob-num js-line-number" data-line-number="32"></td>
        <td id="LC32" class="blob-code blob-code-inner js-file-line">      <span class="pl-k">if</span> (<span class="pl-k">!</span><span class="pl-c1">this</span>.<span class="pl-c1">id</span> <span class="pl-k">&amp;&amp;</span> previousSiblingName) {</td>
      </tr>
      <tr>
        <td id="L33" class="blob-num js-line-number" data-line-number="33"></td>
        <td id="LC33" class="blob-code blob-code-inner js-file-line">        <span class="pl-c1">this</span>.<span class="pl-c1">id</span> <span class="pl-k">=</span> <span class="pl-en">$</span>(<span class="pl-c1">this</span>).<span class="pl-en">attr</span>( <span class="pl-s"><span class="pl-pds">&quot;</span>id<span class="pl-pds">&quot;</span></span>, <span class="pl-smi">previousSiblingName</span>.<span class="pl-c1">replace</span>(<span class="pl-sr"><span class="pl-pds">/</span><span class="pl-cce">\.</span><span class="pl-pds">/</span>g</span>, <span class="pl-s"><span class="pl-pds">&quot;</span>-<span class="pl-pds">&quot;</span></span>) );</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC35" class="blob-code blob-code-inner js-file-line">      <span class="pl-k">return</span> <span class="pl-c1">this</span>.<span class="pl-c1">id</span>;</td>
      </tr>
      <tr>
        <td id="L36" class="blob-num js-line-number" data-line-number="36"></td>
        <td id="LC36" class="blob-code blob-code-inner js-file-line">    }), output <span class="pl-k">=</span> <span class="pl-en">$</span>(<span class="pl-c1">this</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC38" class="blob-code blob-code-inner js-file-line">      <span class="pl-en">$</span>(<span class="pl-c1">this</span>).<span class="pl-en">hide</span>();</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC62" class="blob-code blob-code-inner js-file-line">        <span class="pl-c1">window</span>.<span class="pl-c1">location</span>.<span class="pl-c1">hash</span> <span class="pl-k">=</span> <span class="pl-c1">this</span>.<span class="pl-c1">id</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC71" class="blob-code blob-code-inner js-file-line">      <span class="pl-k">if</span> (this_level <span class="pl-k">===</span> level) <span class="pl-c"><span class="pl-c">//</span> same level as before; same indenting</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC73" class="blob-code blob-code-inner js-file-line">      <span class="pl-k">else</span> <span class="pl-k">if</span> (this_level <span class="pl-k">&lt;=</span> level){ <span class="pl-c"><span class="pl-c">//</span> higher level than before; end parent ol</span></td>
      </tr>
      <tr>
        <td id="L74" class="blob-num js-line-number" data-line-number="74"></td>
        <td id="LC74" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">for</span>(<span class="pl-k">var</span> i <span class="pl-k">=</span> this_level; i <span class="pl-k">&lt;</span> level; i<span class="pl-k">++</span>) {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC79" class="blob-code blob-code-inner js-file-line">      <span class="pl-k">else</span> <span class="pl-k">if</span> (this_level <span class="pl-k">&gt;</span> level) { <span class="pl-c"><span class="pl-c">//</span> lower level than before; expand the previous to contain a ol</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC86" class="blob-code blob-code-inner js-file-line">      level <span class="pl-k">=</span> this_level; <span class="pl-c"><span class="pl-c">//</span> update for the next one</span></td>
      </tr>
      <tr>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a href="/ghiculescu/jekyll-table-of-contents/blame/6e442de268cccd0aa67f5466fd1f51ce9a422adf/toc.js" class="dropdown-item js-update-url-with-hash" id="js-view-git-blame">View git blame</a></li>
          <li><a href="/ghiculescu/jekyll-table-of-contents/issues/new" class="dropdown-item" id="js-new-issue">Open new issue</a></li>
      </ul>
    </div>
  </div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2017 <span title="0.18406s from unicorn-3459850534-16lv6">GitHub</span>, Inc.</li>
